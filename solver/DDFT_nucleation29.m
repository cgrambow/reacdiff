...
%isotropic_poly_scale with isotropic_even = false
%remove constant shift 1 in IP_DDFT, cutoff = 1.5*k9
addpath('../../CHACR/GIP')
runoptim = true;
...
[x_opt,~,exitflag,params] = IP_DDFT(tdata,ydata,params,kernelSize,Cspace,options,x_guess,'Nmu',0,'tspan',300,'cutoff',1.5*k0,'isotropic_even',false);
