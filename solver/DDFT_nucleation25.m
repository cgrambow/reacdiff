...
if runoptim
  ...
  frameindex = 1:20:100;
  history_production(resultpath,[1,21,45,125],modelfunc,arg,tdata-tdata(1),ydata,params,kernelSize,Cspace,'FrameIndex',frameindex,'IP_DDFT_arg',{'Nmu',3},'yyaxisLim',[-0.5,1.5;-1,1.2],'k0',k0,'xlim',[min(ydata(:)),2]);
  f = gcf;
