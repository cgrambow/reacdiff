...
logpdf = @(x) IP_DDFT(tdata,ydata,params,kernelSize,Cspace,options,x,'Nmu',0,'discrete',true,'cutoff',k0,'mode','eval');
...
if ~exist(resultpath,'file')
  ...
  [x_start, Smin] = IP_DDFT(tdata,ydata,params,kernelSize,Cspace,options,x_guess,'Nmu',0,'discrete',true,'cutoff',k0);
else
