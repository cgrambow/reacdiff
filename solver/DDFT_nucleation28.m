...
%isotropic_poly_scale with isotropic_even = true
addpath('../../CHACR/GIP')
runoptim = true;
...
resultpath = [largedatapath,'DDFT_nucleation28.mat'];
...
[x_opt,~,exitflag,params] = IP_DDFT(tdata,ydata,params,kernelSize,Cspace,options,x_guess,'Nmu',0,'tspan',300,'cutoff',2*k0,'isotropic_even',true);
