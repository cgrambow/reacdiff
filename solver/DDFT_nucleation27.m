%based on DDFT_nucleation26
%kernelSize=7 (up to 6th order)
addpath('../../CHACR/GIP')
runoptim = true;
...
resultpath = [largedatapath,'DDFT_nucleation27.mat'];
...
[x_opt,~,exitflag,params] = IP_DDFT(tdata,ydata,params,kernelSize,Cspace,options,x_guess,'Nmu',0,'tspan',300,'cutoff',30);
